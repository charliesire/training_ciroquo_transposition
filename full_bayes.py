...
def predictor(x, index, sample_alpha, sample_lambda, myCODEnew, scale, index_lambda_p, index_lambda_q, bMINlambda, bMAXlambda, alpha_star = None, std_bool = False, mm_list = None, mean_std = True, psi = None):
